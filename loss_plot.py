...
#Plotting loss
with open(SCRIPT_PATH +'/train_record3/training_log.txt') as f:
...
ax.set_ylabel("Loss")
# plt.show()
plt.savefig(SCRIPT_PATH +'/train_record3/real_vs_fake_loss_plot.png')
...
ax.set_ylabel("Loss")
# plt.show()
plt.savefig(SCRIPT_PATH +'/train_record3/gen_loss_plot.png')