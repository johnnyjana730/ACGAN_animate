...
from keras.layers import Dense, Reshape, Embedding, multiply
...
class ACGAN():
    ...
    def build_generator(self):
        ...
        latent_class = multiply([latent, cls_Embedding])
    ...
    def build_discriminator(self):
        ...
        x = Conv2D(filters = 16, kernel_size = (3,3), strides = 2, padding = "same",kernel_initializer='glorot_normal', bias_initializer='Zeros')(inp)
        x = LeakyReLU(0.2)(x)
        x = Dropout(0.25)(x)
